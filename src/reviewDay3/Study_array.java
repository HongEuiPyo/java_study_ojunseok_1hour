...
public class Study_array {
    public static void main(String[] args) {
        ...
        int count = scores.length;  //  배열의 길이
...
//        System.out.println(scores[5]);  //  java.lang.ArrayIndexOutofBoundsException 호출
        ...
        names = new String[2];
//        System.out.println(names[0].length());  //  java.lang.NullpointerException 호출
